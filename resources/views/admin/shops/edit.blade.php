...
<li class="breadcrumb-item"><a href="{{ route('admin.shops.show', $shop) }}">{{ $shop->name }}</a></li>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('owner_name') is-invalid @enderror" 
                                                   id="owner_name" name="owner_name" value="{{ old('owner_name', $shop->owner_name) }}" required>
                                            @error('owner_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" 
                                              id="address" name="address" rows="2" required>{{ old('address', $shop->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('city') is-invalid @enderror" 
                                                   id="city" name="city" value="{{ old('city', $shop->city) }}" required>
                                            @error('city')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('zip_code') is-invalid @enderror" 
                                                   id="zip_code" name="zip_code" value="{{ old('zip_code', $shop->zip_code) }}">
                                            @error('zip_code')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('map_embed_url') is-invalid @enderror" 
                                              ...
                                              placeholder="Paste the full iframe code or just the src URL here">{{ old('map_embed_url', $shop->map_embed_url) }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="time" class="form-control @error('opening_time') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('opening_time', $shop->opening_time ? \Carbon\Carbon::parse($shop->opening_time)->format('H:i') : '08:00') }}" required>
                                            @error('opening_time')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="time" class="form-control @error('closing_time') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old('closing_time', $shop->closing_time ? \Carbon\Carbon::parse($shop->closing_time)->format('H:i') : '17:00') }}" required>
                                            @error('closing_time')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        @php
                                            ...
                                            $selectedWorkingDays = old('working_days', $shop->working_days ?? [1, 2, 3, 4, 5]);
                                        @endphp
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input @error('working_days') is-invalid @enderror" 
                                                           ...
                                                           value="{{ $value }}" 
                                                           id="day{{ $value }}"
                                                           {{ in_array($value, $selectedWorkingDays) ? 'checked' : '' }}>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="text-center mb-3">
                                    <img id="currentImage" src="{{ $shop->image_url }}" 
                                         alt="{{ $shop->name }}" 
                                         class="img-thumbnail"
                                ...
                                <div class="mb-3">
                                    <label for="image" class="form-label">Change Shop Photo</label>
                                    <input type="file" class="form-control @error('image') is-invalid @enderror" 
                                           id="image" name="image" accept="image/*" onchange="previewImage(this)">
                                    <small class="form-text text-muted">
                                        Leave empty to keep current image. Recommended size: 800x600px. Max file size: 4MB.
                                    </small>
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $shop->sort_order) }}" min="0">
                                    <small class="form-text text-muted">
