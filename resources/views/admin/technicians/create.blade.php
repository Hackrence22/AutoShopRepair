        ...
        <div class="col-12">
            <div class="d-flex flex-wrap justify-content-between align-items-center p-4 mb-3 shadow-sm bg-white rounded-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="fw-bold mb-1" style="font-size:2rem; color:#2c3e50;">Add New Technician</h1>
                        <p class="mb-0 text-secondary">Create a new technician profile for your shop</p>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="specialization" id="specialization" class="form-control @error('specialization') is-invalid @enderror" 
                                           value="{{ old('specialization') }}" placeholder="e.g., Engine Repair, Brake Systems">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="bio" id="bio" rows="4" class="form-control @error('bio') is-invalid @enderror" 
                                              placeholder="Tell us about the technician's background and skills...">{{ old('bio') }}</textarea>
                                    @error('bio')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="certifications" id="certifications" class="form-control @error('certifications') is-invalid @enderror" 
                                           value="{{ old('certifications') }}" placeholder="e.g., ASE Certified, Manufacturer Training">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="working_days[]" id="day_{{ $key }}" 
                                                                   ...
                                                                   {{ in_array($key, old('working_days', [])) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="hourly_rate" id="hourly_rate" class="form-control @error('hourly_rate') is-invalid @enderror" 
                                           value="{{ old('hourly_rate') }}" min="0" step="0.01" placeholder="0.00">
                                    @error('hourly_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
