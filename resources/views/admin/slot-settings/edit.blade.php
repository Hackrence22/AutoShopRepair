...
@section('title', 'Edit Slot Setting')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form action="{{ route('admin.slot-settings.update', $slotSetting) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <select class="form-select @error('shop_id') is-invalid @enderror" 
                                ...
                                @foreach($shops as $shop)
                                    <option value="{{ $shop->id }}" 
                                            {{ old('shop_id', $slotSetting->shop_id) == $shop->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control @error('start_time') is-invalid @enderror" 
                                        ...
                                        value="{{ old('start_time', \Carbon\Carbon::parse($slotSetting->start_time)->format('H:i')) }}" required>
                                    @error('start_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control @error('end_time') is-invalid @enderror" 
                                        ...
                                        value="{{ old('end_time', \Carbon\Carbon::parse($slotSetting->end_time)->format('H:i')) }}" required>
                                    @error('end_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('slots_per_hour') is-invalid @enderror" 
                                id="slots_per_hour" name="slots_per_hour" 
                                value="{{ old('slots_per_hour', $slotSetting->slots_per_hour) }}" 
                                min="1" required>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" 
                                    {{ old('is_active', $slotSetting->is_active) ? 'checked' : '' }}>
